A flow that monitors all your sensors. Dependant on which timing category you place your sensor in, it will trigger an alert once a sensor doesn't respond within the group time.
